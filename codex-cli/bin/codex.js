#!/usr/bin/env node
// Unified entry point for the Orbit Code CLI.
...
try {
  ...
  if (existsSync(localBinaryPath)) {
    ...
    const updateCommand =
      packageManager === "bun"
        ? "bun install -g @orbit.build/orbit-code@latest"
        : "npm install -g @orbit.build/orbit-code@latest";
    throw new Error(
      `Missing optional dependency ${platformPackage}. Reinstall Orbit Code: ${updateCommand}`,
    );
  }
}
...
/**
 * Use heuristics to detect the package manager that was used to install Orbit Code
...
const packageManagerEnvVar =
  detectPackageManager() === "bun"
    ? "ORBIT_MANAGED_BY_BUN"
    : "ORBIT_MANAGED_BY_NPM";

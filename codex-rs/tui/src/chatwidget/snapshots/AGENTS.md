...
This file applies to `codex-rs/tui/src/chatwidget/snapshots/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.

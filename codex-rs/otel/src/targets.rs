pub(crate) const OTEL_TARGET_PREFIX: &str = "orbit_code_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "orbit_code_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "orbit_code_otel.trace_safe";

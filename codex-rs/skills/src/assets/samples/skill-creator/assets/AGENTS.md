# codex-rs/skills/src/assets/samples/skill-creator/assets/

This file applies to `codex-rs/skills/src/assets/samples/skill-creator/assets/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Visual assets for the skill-creator skill.

### Key files

- `skill-creator.png` -- full-size skill icon.
- `skill-creator-small.svg` -- compact SVG icon.

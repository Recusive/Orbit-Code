# codex-rs/skills/src/assets/samples/skill-installer/assets/

This file applies to `codex-rs/skills/src/assets/samples/skill-installer/assets/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Visual assets for the skill-installer skill.

### Key files

- `skill-installer.png` -- full-size skill icon.
- `skill-installer-small.svg` -- compact SVG icon.

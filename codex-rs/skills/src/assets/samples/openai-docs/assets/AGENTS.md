...
This file applies to `codex-rs/skills/src/assets/samples/openai-docs/assets/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Visual assets for the openai-docs skill.

### Key files

- `openai.png` -- full-size skill icon.
- `openai-small.svg` -- compact SVG icon for UI listings.

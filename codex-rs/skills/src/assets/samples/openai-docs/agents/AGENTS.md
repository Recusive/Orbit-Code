# codex-rs/skills/src/assets/samples/openai-docs/agents/

This file applies to `codex-rs/skills/src/assets/samples/openai-docs/agents/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Agent configuration for the openai-docs skill.

### Key files

- `openai.yaml` -- agent definition specifying the skill's behavior, tools, and reference documents.

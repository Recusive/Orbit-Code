# codex-rs/apply-patch/tests/fixtures/scenarios/008_rejects_empty_update_hunk/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/008_rejects_empty_update_hunk/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 008_rejects_empty_update_hunk.
Contains `foo.txt` which should remain untouched after the patch fails.

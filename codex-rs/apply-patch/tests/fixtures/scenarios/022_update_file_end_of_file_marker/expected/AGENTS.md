# codex-rs/apply-patch/tests/fixtures/scenarios/022_update_file_end_of_file_marker/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/022_update_file_end_of_file_marker/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after the end-of-file marker patch.
Contains `tail.txt` with "second updated" at the end of the file.

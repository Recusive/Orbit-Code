# codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/expected/old/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/expected/old/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected state of the `old/` directory after the move. Contains `other.txt` (unchanged).
The original `name.txt` has been moved to `renamed/dir/name.txt`.

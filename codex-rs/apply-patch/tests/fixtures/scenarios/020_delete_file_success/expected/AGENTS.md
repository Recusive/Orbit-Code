# codex-rs/apply-patch/tests/fixtures/scenarios/020_delete_file_success/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/020_delete_file_success/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after the delete-file patch.
Contains `keep.txt` only; `obsolete.txt` has been removed.

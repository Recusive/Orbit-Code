# codex-rs/apply-patch/tests/fixtures/scenarios/020_delete_file_success/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/020_delete_file_success/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 020_delete_file_success.
Contains `obsolete.txt` (to be deleted) and `keep.txt` (to remain).

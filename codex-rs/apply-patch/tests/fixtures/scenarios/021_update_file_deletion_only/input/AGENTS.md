# codex-rs/apply-patch/tests/fixtures/scenarios/021_update_file_deletion_only/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/021_update_file_deletion_only/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 021_update_file_deletion_only.
Contains `lines.txt` with three lines (line1, line2, line3).

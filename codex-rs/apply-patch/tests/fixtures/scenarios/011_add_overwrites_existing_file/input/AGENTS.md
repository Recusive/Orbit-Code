# codex-rs/apply-patch/tests/fixtures/scenarios/011_add_overwrites_existing_file/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/011_add_overwrites_existing_file/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 011_add_overwrites_existing_file.
Contains `duplicate.txt` with "old content" that will be overwritten.

# codex-rs/apply-patch/tests/fixtures/scenarios/005_rejects_empty_patch/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/005_rejects_empty_patch/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 005_rejects_empty_patch.

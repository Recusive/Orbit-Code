# codex-rs/apply-patch/tests/fixtures/scenarios/012_delete_directory_fails/input/dir/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/012_delete_directory_fails/input/dir/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Input subdirectory targeted for deletion by the patch. Contains `foo.txt`.
The delete should fail because this is a directory, not a file.

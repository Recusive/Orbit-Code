# codex-rs/apply-patch/tests/fixtures/scenarios/012_delete_directory_fails/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/012_delete_directory_fails/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 012_delete_directory_fails.
Contains `dir/` with `foo.txt` inside. The patch targets `dir` for deletion.

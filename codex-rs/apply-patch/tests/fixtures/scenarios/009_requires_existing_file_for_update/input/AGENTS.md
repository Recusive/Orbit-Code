# codex-rs/apply-patch/tests/fixtures/scenarios/009_requires_existing_file_for_update/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/009_requires_existing_file_for_update/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 009_requires_existing_file_for_update.
Contains `foo.txt` (unrelated file that should remain untouched).

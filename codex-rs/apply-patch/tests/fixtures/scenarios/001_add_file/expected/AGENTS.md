# codex-rs/apply-patch/tests/fixtures/scenarios/001_add_file/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/001_add_file/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after applying the 001_add_file scenario patch.
Contains `bar.md`, the newly created file with content "This is a new file".

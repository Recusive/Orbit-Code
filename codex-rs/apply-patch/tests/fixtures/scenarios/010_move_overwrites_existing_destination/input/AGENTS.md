# codex-rs/apply-patch/tests/fixtures/scenarios/010_move_overwrites_existing_destination/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/010_move_overwrites_existing_destination/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 010.
Contains `old/name.txt` (source), `old/other.txt` (untouched), and `renamed/dir/name.txt` (pre-existing destination to be overwritten).

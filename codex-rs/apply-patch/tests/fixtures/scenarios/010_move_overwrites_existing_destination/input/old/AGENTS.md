# codex-rs/apply-patch/tests/fixtures/scenarios/010_move_overwrites_existing_destination/input/old/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/010_move_overwrites_existing_destination/input/old/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Input subdirectory. Contains `name.txt` (source for the move) and `other.txt` (unchanged).

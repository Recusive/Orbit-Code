# codex-rs/apply-patch/tests/fixtures/scenarios/010_move_overwrites_existing_destination/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/010_move_overwrites_existing_destination/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after the move-overwrite patch.
Contains `old/other.txt` (unchanged) and `renamed/dir/name.txt` (overwritten with "new").

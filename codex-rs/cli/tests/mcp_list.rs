...
fn orbit_code_command(orbit_code_home: &Path) -> Result<assert_cmd::Command> {
    let mut cmd = assert_cmd::Command::new(orbit_code_utils_cargo_bin::cargo_bin("orbit-code")?);
...
fn list_shows_empty_state() -> Result<()> {
    ...
    let mut cmd = orbit_code_command(orbit_code_home.path())?;
...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = orbit_code_command(orbit_code_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(orbit_code_home.path()).await?;
    ...
    let mut list_cmd = orbit_code_command(orbit_code_home.path())?;
    ...
    let mut list_json_cmd = orbit_code_command(orbit_code_home.path())?;
    ...
    let mut get_cmd = orbit_code_command(orbit_code_home.path())?;
    ...
    assert!(stdout.contains("remove: orbit-code mcp remove docs"));

    let mut get_json_cmd = orbit_code_command(orbit_code_home.path())?;
    get_json_cmd

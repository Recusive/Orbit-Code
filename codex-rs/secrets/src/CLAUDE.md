...
- **local** (`local.rs`) -- `LocalSecretsBackend`: age-encrypted file storage at `~/.codex/secrets/local.age`, passphrase management via OS keyring, read-modify-write encryption cycle

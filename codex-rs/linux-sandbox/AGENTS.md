...
This file applies to `codex-rs/linux-sandbox/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.

...
use crate::auth::ORBIT_API_KEY_ENV_VAR;
...
pub(crate) struct AuthEnvTelemetry {
    ...
    pub(crate) orbit_code_api_key_env_present: bool,
    pub(crate) orbit_code_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub(crate) fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            orbit_code_api_key_env_present: self.orbit_code_api_key_env_present,
            orbit_code_api_key_env_enabled: self.orbit_code_api_key_env_enabled,
...
pub(crate) fn collect_auth_env_telemetry(
    ...
    orbit_code_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        orbit_code_api_key_env_present: env_var_present(ORBIT_API_KEY_ENV_VAR),
        orbit_code_api_key_env_enabled,

...
GENERATED_TARGETS = [
    Path("src/orbit_code_app_server/generated/notification_registry.py"),
    Path("src/orbit_code_app_server/generated/v2_all.py"),
    Path("src/orbit_code_app_server/api.py"),
]

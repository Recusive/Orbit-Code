...
#   filename:  orbit_code_app_server_protocol.v2.schemas.json
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_orbit_code_folder: Annotated[AbsolutePathBuf, Field(alias="dotCodexFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.orbit, etc.).",
        ),
    ] = None
...
class TurnError(BaseModel):
    ...
    orbit_code_error_info: Annotated[

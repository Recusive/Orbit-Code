...
This file applies to `sdk/python/src/codex_app_server/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.

...
past and future “Contributions” submitted to the **Orbit CLI project
(the “Project”)**.
...
You grant **Recursive, Inc.** and all recipients of software distributed by the
...
You grant **Recursive, Inc.** and all recipients of the Project a perpetual,
